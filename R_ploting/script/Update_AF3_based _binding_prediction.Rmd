...
data_processed <- filtered_data %>%
  mutate(
    Accuracy = ifelse((`ipTM.flg22_FLS2` >= 0.83 & Known_outcome == "Perception") | 
                      (`ipTM.flg22_FLS2` < 0.83 & Known_outcome == "No perception"), 1, 0),
    Type_1_Error = ifelse(`ipTM.flg22_FLS2` >= 0.83 & Known_outcome == "No perception", 1, 0),
    Type_2_Error = ifelse(`ipTM.flg22_FLS2` < 0.83 & Known_outcome == "Perception", 1, 0)
  ) %>%
