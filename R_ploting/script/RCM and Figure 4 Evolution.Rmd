...
file_path <- "../input/rcm/fagales_RCM_43FLS2.txt" # Replace path_to_your_file with the actual path
...
matrix_rcm_fagales <- read.csv("../output/rcm_qv_matrix_output.csv", header = TRUE)
...
# Read the data from the file
file_path <- "../input/rcm/26_Vitales_order_RCM_txt" # Replace path_to_your_file with the actual path
