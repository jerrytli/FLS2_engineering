...
file_path <- "../input/rcm/42_fagales_rcm_score" # Replace path_to_your_file with the actual path
...
# Read the data from the file
file_path <- "../input/rcm/26_Vitales_rcm_score" # Replace path_to_your_file with the actual path
