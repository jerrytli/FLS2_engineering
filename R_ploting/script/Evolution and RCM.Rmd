...
# Filter data for marginal plot (outlined residues only)
marginal_data <- subset(data, has_outline)
...
marginal_plot <- ggplot(marginal_data, aes(x = Distance_Y)) +
...
# Save the plot
ggsave("../output/omega/combined_distances_plot_flg22_full.pdf", final_plot, width = 6, height = 4.5)
...
# Create the marginal density plot
marginal_plot <- ggplot(marginal_data, aes(x = Distance_Z)) +
  geom_density(fill = "deepskyblue4", alpha = 0.5) +
  # Align axes with scatter plot
