...
ggplot(data, aes(x = Distance, y = dn.ds)) +
  # Points for dn/ds < 1
  geom_point(data = subset(data, category == "dn/ds < 1"), color = "grey", size = 2) +
  # Points for dn/ds >= 1
  geom_point(data = subset(data, category == "dn/ds >= 1"), color = "deepskyblue4", size = 2) +
  # Highlighted residues
  geom_point(data = subset(data, category == "Highlighted Residues"), color = "red", size = 3) +
  # Horizontal line at dn/ds = 1
  geom_hline(yintercept = 1, color = "red", linetype = "dashed", size = 1) +
  # Customize labels and titles
  labs(
    title = "Scatter Plot of dN/dS vs Distance from the Sheet",
    x = "Distance from the Sheet",
    y = "dN/dS",
    color = NULL
  ) +
  # Additional styling
