...
fagales_range <- c(216, 287)
brassicales_range <- c(219, 290)
rosales_range <- c(216, 287)
...
ggplot(combined_data, aes(x = relative_pos, y = `dN.dS`, fill = color)) +
  ...
  scale_x_continuous(expand = c(0, 0), breaks = c(0, 11, 25, 35, 49, 59, 72), labels = c("0"," ", "25", " ", "49", " ","72")) +
  scale_y_continuous(expand = c(0, 0)) + # Remove padding in y-axis
  labs(x = "Amino Acid Position", y = expression(Posterior ~ mean ~ omega ~ "(dN/dS)")) +
  theme_classic() +
  theme(legend.position = "right",
         axis.text.x = element_text(size = 14, color = "black"),
        axis.text.y = element_text(size = 14, color = "black"))
ggsave("../output/omega_region_1.pdf", width = 7.5, height = 2)
...
```{r}
# Define ranges for each group
fagales_range <- c(411, 482)
brassicales_range <- c(408, 479)
rosales_range <- c(411, 482)
...
ggplot(combined_data, aes(x = relative_pos, y = `dN.dS`, fill = color)) +
  ...
  theme_classic() +
   theme(legend.position = "right",
        ...
        axis.text.y = element_text(size = 14, color = "black"),
        axis.title.y = element_text(size = 14, color = "black"))
ggsave("../output/omega_region_2.pdf", width = 7.5, height = 3)
...
# Read the data from the file
file_path <- "../input/13_vitales_rcm_scores.txt" # Replace path_to_your_file with the actual path
