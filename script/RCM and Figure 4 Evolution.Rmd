...
file_path <- "../input/fagales_RCM_43FLS2.txt" # Replace path_to_your_file with the actual path
rcm_qv <- read.csv(file_path, header = FALSE, sep = ",", strip.white = TRUE)

# Convert the data frame to a vector of values
values <- as.numeric(unlist(rcm_qv))
...
matrix_rcm_qv <- read.csv("../output/rcm_qv_matrix_output.csv", header = TRUE)
...
# Print the heatmap
print(heatmap_plot)
ggsave("../output/RCM_fagales.pdf", width = 3.7, height = 5)
```
...
# Read the data from the file
file_path <- "../input/26_Vitales_order_RCM_txt" # Replace path_to_your_file with the actual path
...
# Optionally, write the matrix to a new CSV file if needed
write.csv(matrix_rcm, "../output/vitales_matrix_output.csv", row.names = FALSE)
...
# Read the matrix data
matrix_rcm <- read.csv("../output/vitales_matrix_output.csv", header = TRUE)
...
# Print the heatmap
print(heatmap_plot)
ggsave("../output/RCM_Vitales.pdf", width = 3.7, height = 5)
```
