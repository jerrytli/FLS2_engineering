...
roc_plot <- ggplot() +
  ...
  annotate("text", x = 0.95, y = 0.19, label = sprintf("AUC (AtFLS2): %.2f", auc_AtFLS2), color = "#ccbb44", hjust = 1, vjust = 0, size = 7) +
  annotate("text", x = 0.95, y = 0.12, label = sprintf("AUC (All): %.2f", auc_all), color = "#4477aa", hjust = 1, vjust = 0, size = 7) +
